...
\begin{articleheader}
\sectionwithauthors{}{A DEVELOPMENT OF BOILED SAUSAGE TECHNOLOGY BASED ON HORSE MEAT}
...
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1046}}
...
%% The control sample
%% 
%% Boiled sausage «Donskoy»
%% 
%% (GOST 31780-2012)
%% \end{minipage}} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2993} + 4\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Experimental samples with the addition of a mixture of dried beetroot
...
%% High-grade veneered horse meat
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% 75,0
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% 60,0
...
%% \end{minipage} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% A mixture of dried beetroot and dried orange peel powders
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% -
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% 0,5
...
%% \end{minipage} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Spices and materials kg per 100 kg of unsalted raw materials}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Table 2 -- Organoleptic evaluation of boiled horse meat sausage with the addition of dried beet powder and orange zest}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2681}}
...
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1870}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2046}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% Parameter
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Control sample
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Prototype with addition of 0.5\% powder mixture
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Prototype with addition of 1\% powder mixture
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Prototype with addition of 1.5\% powder mixture
%% \end{minipage} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Appearance
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2026}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1858}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1967}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2124}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0011}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.0019}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1995}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Name of the indicator
%% \end{minipage}} &
%% \multicolumn{6}{>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.7974} + 10\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Value of the indicator for sausages
%% \end{minipage}} \\
%% & \begin{minipage}[b]{\linewidth}\centering
%% Control sample
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Sample with addition of 0,5\% powder mixture
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Sample with addition of 1\% powder mixture
%% \end{minipage} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2025} + 4\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Sample with addition of 1,5\% powder mixture
%% \end{minipage}} \\
%% \multicolumn{7}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{1.0000} + 12\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Organoleptic indicators:}
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Appearance
%% \end{minipage} &
%% \multicolumn{6}{>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.7974} + 10\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Loaves with a clean, dry surface, without damaged shells, minced meat
%% drips, slips and fatty swellings
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Consistency
%% \end{minipage} &
...
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Color and appearance of minced meat on the cut
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% The mince is pink in color, evenly mixed, without grey spots and
%% contains the pieces of raw mutton fat
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% The mince is light red in color, evenly mixed, without grey spots and
%% contains the pieces of raw mutton fat
%% \end{minipage} &
%% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2135} + 2\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
%% The mince is red in color, evenly mixed, without grey spots and contains
%% the pieces of raw mutton fat
%% \end{minipage}} &
%% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2014} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
%% The mince is dark red in color, evenly mixed, without grey spots and
%% contains the pieces of raw mutton fat
%% \end{minipage}} \\
%% \multicolumn{7}{@{}>{\raggedright\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{1.0000} + 12\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Microbiological indicators:}
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% TBC (Total Bacterial Count), CFU/g
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% ≤ 1×10⁵
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% ≤ 1×10⁵
%% \end{minipage} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2135} + 2\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% ≤ 1×10⁵
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2014} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% ≤ 1×10⁵
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Coliforms (BGKP), CFU/0.01 g
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Not allowed
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Not detected
...
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% Pathogenic microorganisms, including Salmonella, in 25 g
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Not allowed
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Not detected
%% \end{minipage} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2154} + 4\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Not detected
%% \end{minipage}} & \begin{minipage}[b]{\linewidth}\centering
%% Not detected
...
%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.4465}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.2306}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 4\tabcolsep) * \real{0.3229}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% Indicator
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% The control sample
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% A prototype with the addition of 1 \% powder mixture
%% \end{minipage} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
...
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1941}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2416}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Indicators
%% \end{minipage}} &
%% \multicolumn{4}{>{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.8224} + 6\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% The studied samples
%% \end{minipage}} \\
%% & \begin{minipage}[b]{\linewidth}\centering
%% Raw minced meat without added ingredients
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Boiled sausage «Donskoy»
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Raw minced meat with the addition of 1\% powder mixture
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% Boiled sausage with the addition of 1\% powder mixture
%% \end{minipage} \\
%% \begin{minipage}[b]{\linewidth}\raggedright
%% MBC, \%
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
