...
\tcap{Table 4 - Adsorption characteristic of samples (N\textsubscript{2})}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 5 - Results of the study of sorption of PUM (by CO\textsubscript{2})}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 6 - Results of the study of hydrogen sorption with potassium humate}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 7 -- Comparative table of specific surface area S(\textsubscript{BET}) for N\textsubscript{2}, CO\textsubscript{2} and H\textsubscript{2}}
\begin{longtblr}[
  label = none,
  entry = none,
]{
