...
%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2180}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2180}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2760}}
...
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Массовая доля Fe\textsubscript{общ}., \%
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.5641} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Массовая доля класса крупности (мм), \%
%% \end{minipage}} \\
%% & & \begin{minipage}[b]{\linewidth}\centering
%% -0,071 мм
...
%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1676}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0800}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0912}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0912}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0912}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0913}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0919}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0924}}
%%   >{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.2033}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Наименование материала
%% \end{minipage}} &
%% \multicolumn{7}{>{\centering\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.6291} + 12\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Рис.2 - Распределение воды в слое концентрата}
...
{\bfseries Таблица 3 - Физические свойства концентрата АО «ССГПО»}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1072}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1349}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1365}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1365}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1668}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1432}}
%%   >{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.1747}}@{}}
%% \toprule\noalign{}
%% \multicolumn{2}{@{}>{\centering\arraybackslash}p{(\linewidth - 12\tabcolsep) * \real{0.2422} + 2\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Массовая доля, \%
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Истинная плотность, г/см\textsuperscript{3}
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Насыпная плотность, т/м\textsuperscript{3}
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Удельная поверхность,см\textsuperscript{2}/г
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Радиус капилляра,
%% 
...
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Скорость капиллярного всасывания,
%% 
%% см/сек
%% \end{minipage}} \\
%% \begin{minipage}[b]{\linewidth}\centering
...
%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1518}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.0602}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1065}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1370}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1660}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1062}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1400}}
%%   >{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.1324}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
%% Наименование связующего
%% \end{minipage}} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 14\tabcolsep) * \real{0.3036} + 4\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Массовая доля, \%
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
...
%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.2114}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0768}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0751}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0016}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0816}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0816}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0028}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0788}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0818}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0770}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0772}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0770}}
%%   >{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0772}}@{}}
%% \toprule\noalign{}
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\centering
...
%% \end{minipage}} &
%% \multicolumn{12}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.7886} + 22\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Наименование связующего
%% \end{minipage}} \\
%% &
%% \multicolumn{8}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.4802} + 14\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% бентонит
%% \end{minipage}} &
%% \multicolumn{4}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.3084} + 6\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% БПК
%% \end{minipage}} \\
%% \midrule\noalign{}
...
%% \endlastfoot
%% 1 Расход связующего, \% &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.1520} + 2\tabcolsep}}{%
%% 0,30} &
%% \multicolumn{4}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.1676} + 6\tabcolsep}}{%
%% 0,40} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.1606} + 2\tabcolsep}}{%
%% 0,50} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.1542} + 2\tabcolsep}}{%
%% 0,30} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.1542} + 2\tabcolsep}@{}}{%
%% 0,40} \\
%% \multirow{2}{=}{2 Массовая доля влаги, \%} & К &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0767} + 2\tabcolsep}}{%
%% Б} & К & Б &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0817} + 2\tabcolsep}}{%
%% К} & Б & К & БПК & К & БПК \\
%% & 8,94 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0767} + 2\tabcolsep}}{%
%% 7,85} & 8,94 & 7,85 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0817} + 2\tabcolsep}}{%
%% 8,94} & 7,85 & 8,94 & 8,15 & 8,94 & 8,15 \\
%% 3 Дозировка на сухую массу, \% & 99,70 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0767} + 2\tabcolsep}}{%
%% 0,30} & 99,6 & 0,40 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0817} + 2\tabcolsep}}{%
%% 99,50} & 0,50 & 99,70 & 0,30 & 99,60 & 0,40 \\
%% 4 Дозировка на влажную массу, \% & 99,70 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0767} + 2\tabcolsep}}{%
%% 0,30} & 99,60 & 0,40 &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 24\tabcolsep) * \real{0.0817} + 2\tabcolsep}}{%
%% 99,49} & 0,51 & 99,70 & 0,30 & 99,60 & 0,30 \\
%% \end{longtable}
...
Таблица 6 - Результаты лабораторных испытаний окатышей из концентрата\\
АО «ССГПО» полученных с применением разными связующих

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3688}}
...
%% Наименование показателей
%% \end{minipage}} &
%% \multicolumn{5}{>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.6312} + 8\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Наименование связующего
%% \end{minipage}} \\
%% &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.3696} + 4\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% ТОО «ТАГБЕНТ» (бентонит)
%% \end{minipage}} &
%% \multicolumn{2}{>{\centering\arraybackslash}p{(\linewidth - 10\tabcolsep) * \real{0.2616} + 2\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% БПК
%% \end{minipage}} \\
%% \midrule\noalign{}
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% Расход связующего, \% & 0,30 & 0,40 & 0,50 & 0,30 & 0,40 \\
%% Массовая доля влаги, \%
%% 
%% - сырые окатыши & 8,20 & 8,31 & 8,27 & 8,14 & 8,19 \\
%% Массовая доля класса крупности (мм), \%
%% 
%% +16
%% 
...
%% 
%% 0,0 \\
%% Диаметр сырых окатышей, мм & 10,34 & 11,28 & 11,68 & 10,40 & 11,15 \\
%% Пористость сухих окатышей, \% & 32,1 & 31,7 & 30,8 & 31,5 & 30,2 \\
%% \end{longtable}
...
%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0603}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0773}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0597}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.1051}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0702}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0650}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0745}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0597}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0863}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0614}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0673}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0728}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0807}}
%%   >{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.0597}}@{}}
%% \toprule\noalign{}
...
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
%% \begin{quote}
%% Расход, связующей добавки, \%
%% \end{quote}
%% \end{minipage}} &
%% \multicolumn{3}{>{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.2349} + 4\tabcolsep}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Прочностные характеристики обожжённых окатышей
%% \end{minipage}} &
%% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
%% Пористость, \%
%% \end{minipage}} &
%% \multicolumn{8}{>{\centering\arraybackslash}p{(\linewidth - 26\tabcolsep) * \real{0.5625} + 14\tabcolsep}@{}}{%
%% \begin{minipage}[b]{\linewidth}\centering
%% Химический состав, \%
%% \end{minipage}} \\
%% & & \begin{minipage}[b]{\linewidth}\raggedright
%% \begin{quote}
%% на удар (Б\textsuperscript{+5}), \%
%% \end{quote}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% \begin{quote}
%% сопротивление истиранию (Б\textsuperscript{-0,5}), \%
%% \end{quote}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% \begin{quote}
%% на сжатие, кг/ок.
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% \multirow{3}{=}{Бентонит} & 0,30 & 97,5 & 2,5 & 306,0 & 22,6 & 66,55 &
%% 0,72 & 2,61 & 0,55 & 0,71 & 0,96 & 0,0022 & 0,23 \\
%% & 0,40 & 98,0 & 2,0 & 314,0 & 21,7 & 66,44 & 0,66 & 2,70 & 0,51 & 0,71 &
%% 0,99 & 0,0018 & 0,19 \\
%% & 0,50 & 98,2 & 1,8 & 392,0 & 21,2 & 66,34 & 0,82 & 2,72 & 0,55 & 0,71 &
%% 1,00 & 0,0017 & 0,22 \\
%% \multirow{2}{=}{БПК} & 0,30 & 97,6 & 2,4 & 279,0 & 23,3 & 66,60 & 0,82 &
%% 2,61 & 0,49 & 0,70 & 0,99 & 0,0021 & 0,23 \\
%% & 0,40 & 98,1 & 1,9 & 318,0 & 22,8 & 66,34 & 0,94 & 2,68 & 0,52 & 0,70 &
%% 0,99 & 0,0022 & 0,20 \\
%% \end{longtable}
